...
function NavBar() {
  ...
  <div class="gjs-row" id="im3y">
    <div class="gjs-cell" id="i8si">
      <div class="gjs-row" id="i0uj">
        <div class="gjs-cell" id="iy6x">
                            <button type="button" id="i0pht" onClick={() => navigate("/")}>Home Page</button>
        </div>
      </div>
      <div class="gjs-row" id="ilbcp">
        <div class="gjs-cell" id="iwq3l">
          <button type="button" id="ih7sl" onClick={() => navigate("/education")}>Education</button>
        </div>
      </div>
      <div class="gjs-row" id="i7o2o">
        <div class="gjs-cell" id="i1i16">
          <button type="button" id="ixjiv" onClick={() => navigate("/search")}>Search for Patient</button>
        </div>
      </div>
      <div class="gjs-row" id="ig2nm">
        <div class="gjs-cell" id="i4qdz">
